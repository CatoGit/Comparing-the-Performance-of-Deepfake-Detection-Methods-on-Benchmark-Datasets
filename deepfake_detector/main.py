...
if __name__ == "__main__":
    ...
    model, average_auc, average_ap, average_acc, average_loss = DFDetector.train_method(
        ...
        img_save_path="C:/Users/Chris/Desktop/fake_videos", epochs=1, batch_size=32, lr=0.001, folds=1, augmentation_strength="weak", fulltrain=False, faces_available=False, face_margin=0, seed=24)
